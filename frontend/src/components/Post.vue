...
<template>
  <div
    class="post card"
    @click="toggleShowExpandedPost"
    @keydown.enter="toggleShowExpandedPost"
    tabindex="0"
  >
    <button
      class="reply-to"
      v-if="post.reply_to && !isReply"
    ...
    <footer class="card-footer">
      ...
      <button
        class="reposts card-footer-item"
  ...
  <Teleport to="body">
    <ExpandedPost
      ...
      @delete-post="deletePost(post.id, true)"
    />
    <AddPost
      v-if="showAddPost"
      :is-reply="post.id"
